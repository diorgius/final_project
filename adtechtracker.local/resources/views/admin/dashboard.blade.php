        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="flex flex-col items-center pt-5 pb-1">
                    <h3 class="font-semibold text-gray-700 text-xl">Доходы системы:</h3>
                </div>
                <div class="w-2/3 mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] 
                            dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] overflow-hidden rounded-lg">
                </div>
