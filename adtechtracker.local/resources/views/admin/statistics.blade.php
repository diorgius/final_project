        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section
                ...
                <div class="flex flex-col items-center w-2/3 mt-6 px-6 py-4 mb-2 bg-white dark:bg-gray-800 
                    ...
                    <p class="border-b-2 font-semibold text-gray-700 dark:text-gray-200 text-xl pb-2">{{ __('statistics.number_active_offers') }} - <span id="active-offers" class="text-indigo-600">{{ $activeOffers }}</span></p>
                    <p class="border-b-2 font-semibold text-gray-700 dark:text-gray-200 text-xl pb-2">{{ __('statistics.number_deactive_offers') }} - <span id="deactive-offers" class="text-indigo-600">{{ $deactiveOffers }}</span></p>
                    ...
                    <p class="border-b-2 font-semibold text-gray-700 dark:text-gray-200 text-xl pb-2">{{ __('statistics.deactive_subscriptions') }} - <span id="deactive-subscriptions" class="text-indigo-600">{{ $deactiveSubscriptions }}</span></p>
