        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="flex flex-col items-center w-2/3 mt-6 px-6 py-4 mb-2 bg-white dark:bg-gray-800 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] 
                    ...
                    <p class="font-semibold text-gray-700 text-xl pb-1">Доходы вебмастеров - <span class="text-indigo-600">{{ $webmasterIncome }}</span></p>
                    <p class="font-semibold text-gray-700 text-xl pb-2">Доходы системы - <span class="text-indigo-600">{{ $systemProfit }}</span></p>
                </div>
            </div>
        </div>
    </section>
