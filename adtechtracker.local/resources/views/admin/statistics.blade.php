        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section
                ...
                <div class="flex flex-col items-center pt-5 pb-1">
                    <p class="font-semibold text-gray-700">Статистика за все время на
                        {{ now()->setTimezone('Europe/Moscow')->format('H:i:s d.m.Y') }}:</p>
                </div>
                <div class="flex flex-col items-center w-2/3 mt-6 px-6 py-4 mb-2 bg-white dark:bg-gray-800 
                    ...
                    <p class="border-b-2 font-semibold text-gray-700 text-xl pb-2">Количество отклоненных
                            переходов по ссылкам - <span id="rejectedClicks" class="text-indigo-600">{{ $rejectedClicks }}</span>
                    </p>
                    <p class="border-b-2 font-semibold text-gray-700 text-xl pb-2">Расходы рекламодателей -
                        <span id="advertiserExpenses" class="text-indigo-600">{{ $advertiserExpenses }}</span>
                    </p>
                    <p class="border-b-2 font-semibold text-gray-700 text-xl pb-1">Доходы вебмастеров - 
                        <span id="webmasterIncome" class="text-indigo-600">{{ $webmasterIncome }}</span></p>
                    <p class="border-b-2 font-semibold text-gray-700 text-xl pb-2">Доходы системы - <span id=" systemProfit"
